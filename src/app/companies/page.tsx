        ...
        <nav className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 md:px-10 sticky top-0 z-50 shadow-sm">
          <div className="flex items-center gap-4">
            <button 
              ...
              className="flex items-center gap-2 text-sm font-semibold text-slate-655 hover:text-slate-900 transition-colors cursor-pointer"
            >
              <i className="fa-solid fa-arrow-left"></i> Back to Companies
            </button>
          </div>
            ...
            <div className="flex flex-col">
              {filteredCompanies.map((company) => (
                ...
                >
                  ...
                  <button 
                    onClick={() => router.push(`/companies?id=${company.companyName}`)}
                    className="ml-4 shrink-0 bg-slate-850 hover:bg-slate-950 text-white text-xs font-bold px-4 py-1.5 rounded-lg active:scale-95 transition-all cursor-pointer"
                  >
                    View
                  </button>
                </div>
